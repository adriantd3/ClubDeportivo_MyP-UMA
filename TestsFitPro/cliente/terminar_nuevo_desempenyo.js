...
export default async function () {
  ...
  try {
    ...
    const numeroDeDesempenos = page.$$("a").length;
    ...
    const terminarEntrenamientoButton = page.locator('button[name="terminar"]');
    terminarEntrenamientoButton.click();
    await page.waitForNavigation();

    //Comprobar que se ha creado un nuevo desempeño
    check(page, {
      "Numero de desempeños sesión ha aumentado": p => p.$$("a").length == numeroDeDesempenos + 1,
    });
